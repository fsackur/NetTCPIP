...
Add-Type -TypeDefinition (Get-Content $PSScriptRoot\NetRouteDiagnostics.Class.cs | Out-String) -ReferencedAssemblies $MmiAssembly -IgnoreWarnings -WarningAction SilentlyContinue
Add-Type -TypeDefinition (Get-Content $PSScriptRoot\TestNetConnectionResult.Class.cs | Out-String) -ReferencedAssemblies $MmiAssembly -IgnoreWarnings -WarningAction SilentlyContinue
